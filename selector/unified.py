...
from quixote.protocol import HtmlResponse, XmlResponse
...
class SelectorList(_ParselSelector.selectorlist_cls, ObjectRef):
...
class Selector(_ParselSelector, ObjectRef):
