...
# scrapy runspider spider_cookies.py
# scrapy runspider spider_cookies.py --nolog
...
class DongmengSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        with open('/Users/muyichun/PycharmProjects/socialpeta/quixote/logs/html/aa.html', 'w') as f:
    ...
    def start_requests(self):
        ...
        return [scrapy.Request('https://www.dongmengdai.com/index.php?user&q=action/login', headers=self.header,
