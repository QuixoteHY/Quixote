# -*- coding:utf-8 -*-
# @Time     : 2019-01-19 00:34
# @Author   : 胡远
# @Github   : https://github.com/QuixoteHY
# @Email    : 1290482442@qq.com
# @Describe : Some helpers for deprecation messages
...
def attribute(obj, oldattr, newattr, version='0.12'):
    ...
    warnings.warn("%s.%s attribute is deprecated and will be no longer supported in Scrapy %s, "
                  "use %s.%s attribute instead" % (cname, oldattr, version, cname, newattr),
