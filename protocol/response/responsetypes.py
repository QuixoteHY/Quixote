...
# @Describe : This module implements a class which returns the appropriate Response class based on different criteria.
...
from quixote.utils.python import binary_is_text, to_bytes, to_native_str
...
class ResponseTypes(object):
    ...
    def from_content_disposition(self, content_disposition):
        try:
            filename = to_native_str(content_disposition, encoding='latin-1',
